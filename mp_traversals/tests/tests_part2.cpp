...
TEST_CASE("Illini I - FloodFilledImage - DFS", "[weight=3][part=2][timeout=14000]") {
...
TEST_CASE("Illini I - FloodFilledImage - BFS", "[weight=3][part=2][timeout=14000]") {
  PNG png;      png.readFromFile("../data/i.png");
...
TEST_CASE("PacMan - FloodFilledImage - DFS", "[weight=3][part=2][valgrind][timeout=40000]") {
...
TEST_CASE("PacMan - FloodFilledImage - BFS", "[weight=3][part=2][valgrind][timeout=40000]") {
  PNG png;      png.readFromFile("../data/pacman.png");
